...
public class SchedulesApi {
    ...
    public ApiResponse<ScheduleFull> getAccountScheduleWithHttpInfo(Integer accountId, Integer scheduleId) throws ApiException {
        com.squareup.okhttp.Call call = getAccountScheduleCall(accountId, scheduleId, null, null);
    ...
    public ApiResponse<ListSchedulesFull> listAccountSchedulesWithHttpInfo(Integer accountId, List<String> filtersId, List<String> filtersName, String sortId, String sortName, Integer limit, Integer offset, String fields) throws ApiException {
        com.squareup.okhttp.Call call = listAccountSchedulesCall(accountId, filtersId, filtersName, sortId, sortName, limit, offset, fields, null, null);
