...
public class GroupsApi {
    ...
    public ApiResponse<GroupFull> createAccountExtensionContactGroupWithHttpInfo(Integer accountId, Integer extensionId, CreateGroupParams data) throws ApiException {
        com.squareup.okhttp.Call call = createAccountExtensionContactGroupCall(accountId, extensionId, data, null, null);
    ...
    public ApiResponse<DeleteGroup> deleteAccountExtensionContactGroupWithHttpInfo(Integer accountId, Integer extensionId, Integer groupId) throws ApiException {
        com.squareup.okhttp.Call call = deleteAccountExtensionContactGroupCall(accountId, extensionId, groupId, null, null);
    ...
    public ApiResponse<GroupFull> getAccountExtensionContactGroupWithHttpInfo(Integer accountId, Integer extensionId, Integer groupId) throws ApiException {
        com.squareup.okhttp.Call call = getAccountExtensionContactGroupCall(accountId, extensionId, groupId, null, null);
        Type localVarReturnType = new TypeToken<GroupFull>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<ListGroupsFull> listAccountExtensionContactGroupsWithHttpInfo(Integer accountId, Integer extensionId, List<String> filtersId, List<String> filtersName, String sortId, String sortName, Integer limit, Integer offset, String fields) throws ApiException {
        com.squareup.okhttp.Call call = listAccountExtensionContactGroupsCall(accountId, extensionId, filtersId, filtersName, sortId, sortName, limit, offset, fields, null, null);
    ...
    public ApiResponse<GroupFull> replaceAccountExtensionContactGroupWithHttpInfo(Integer accountId, Integer extensionId, Integer groupId) throws ApiException {
        com.squareup.okhttp.Call call = replaceAccountExtensionContactGroupCall(accountId, extensionId, groupId, null, null);
        Type localVarReturnType = new TypeToken<GroupFull>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
