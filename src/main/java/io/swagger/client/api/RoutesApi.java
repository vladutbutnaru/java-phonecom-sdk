...
public class RoutesApi {
    ...
    public ApiResponse<RouteFull> createRouteWithHttpInfo(Integer accountId, CreateRouteParams data) throws ApiException {
        com.squareup.okhttp.Call call = createRouteCall(accountId, data, null, null);
    ...
    public ApiResponse<DeleteRoute> deleteAccountRouteWithHttpInfo(Integer accountId, Integer routeId) throws ApiException {
        com.squareup.okhttp.Call call = deleteAccountRouteCall(accountId, routeId, null, null);
    ...
    public ApiResponse<RouteFull> getAccountRouteWithHttpInfo(Integer accountId, Integer routeId) throws ApiException {
        com.squareup.okhttp.Call call = getAccountRouteCall(accountId, routeId, null, null);
        Type localVarReturnType = new TypeToken<RouteFull>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<ListRoutesFull> listAccountRoutesWithHttpInfo(Integer accountId, List<String> filtersId, List<String> filtersName, String sortId, String sortName, Integer limit, Integer offset, String fields) throws ApiException {
        com.squareup.okhttp.Call call = listAccountRoutesCall(accountId, filtersId, filtersName, sortId, sortName, limit, offset, fields, null, null);
    ...
    public ApiResponse<RouteFull> replaceAccountRouteWithHttpInfo(Integer accountId, Integer routeId, CreateRouteParams data) throws ApiException {
        com.squareup.okhttp.Call call = replaceAccountRouteCall(accountId, routeId, data, null, null);
        Type localVarReturnType = new TypeToken<RouteFull>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
