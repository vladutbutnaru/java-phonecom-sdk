...
public class ExtensionsApi {
    ...
    public ApiResponse<ExtensionFull> createAccountExtensionWithHttpInfo(Integer accountId, CreateExtensionParams data) throws ApiException {
        com.squareup.okhttp.Call call = createAccountExtensionCall(accountId, data, null, null);
    ...
    public ApiResponse<ExtensionFull> getAccountExtensionWithHttpInfo(Integer accountId, Integer extensionId) throws ApiException {
        com.squareup.okhttp.Call call = getAccountExtensionCall(accountId, extensionId, null, null);
        Type localVarReturnType = new TypeToken<ExtensionFull>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<ListExtensionsFull> listAccountExtensionsWithHttpInfo(Integer accountId, List<String> filtersId, List<String> filtersExtension, List<String> filtersName, String sortId, String sortExtension, String sortName, Integer limit, Integer offset, String fields) throws ApiException {
        com.squareup.okhttp.Call call = listAccountExtensionsCall(accountId, filtersId, filtersExtension, filtersName, sortId, sortExtension, sortName, limit, offset, fields, null, null);
    ...
    public ApiResponse<ExtensionFull> replaceAccountExtensionWithHttpInfo(Integer accountId, Integer extensionId, ReplaceExtensionParams data) throws ApiException {
        com.squareup.okhttp.Call call = replaceAccountExtensionCall(accountId, extensionId, data, null, null);
        Type localVarReturnType = new TypeToken<ExtensionFull>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
