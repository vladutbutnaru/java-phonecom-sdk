...
public class SubaccountsApi {
    ...
    public ApiResponse<AccountFull> createAccountSubaccountWithHttpInfo(Integer accountId, CreateSubaccountParams data) throws ApiException {
        com.squareup.okhttp.Call call = createAccountSubaccountCall(accountId, data, null, null);
    ...
    public ApiResponse<ListAccountsFull> listAccountSubaccountsWithHttpInfo(Integer accountId, List<String> filtersId, String sortId, Integer limit, Integer offset, String fields) throws ApiException {
        com.squareup.okhttp.Call call = listAccountSubaccountsCall(accountId, filtersId, sortId, limit, offset, fields, null, null);
