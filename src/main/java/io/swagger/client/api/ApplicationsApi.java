...
public class ApplicationsApi {
    ...
    public ApiResponse<ApplicationFull> getAccountApplicationWithHttpInfo(Integer accountId, Integer applicationId) throws ApiException {
        com.squareup.okhttp.Call call = getAccountApplicationCall(accountId, applicationId, null, null);
    ...
    public ApiResponse<ListApplicationsFull> listAccountApplicationsWithHttpInfo(Integer accountId, List<String> filtersId, List<String> filtersName, String sortId, String sortName, Integer limit, Integer offset, String fields) throws ApiException {
        com.squareup.okhttp.Call call = listAccountApplicationsCall(accountId, filtersId, filtersName, sortId, sortName, limit, offset, fields, null, null);
